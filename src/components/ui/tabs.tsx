...
const TabsContent = React.forwardRef<
  React.ElementRef<typeof TabsPrimitive.TabPanel>,
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.TabPanel>
>(({ className, ...props }, ref) => (
...
TabsContent.displayName = TabsPrimitive.TabPanel.displayName
